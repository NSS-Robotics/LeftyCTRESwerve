...
public class Intake extends SubsystemBase {
    private static TalonFX intakeMotor = new TalonFX(
        Constants.CanIDs.intakeMotorID
    );
    ...
    public Intake(RobotContainer rob) {
        ...
        intakeSlot0Configs.kP = Constants.Intake.intakeKP;
        intakeSlot0Configs.kI = Constants.Intake.intakeKI;
        intakeSlot0Configs.kD = Constants.Intake.intakeKD;
        intakeSlot0Configs.kS = Constants.Intake.intakeKS;
        intakeSlot0Configs.kV = Constants.Intake.intakeKV;
        intakeSlot0Configs.kA = Constants.Intake.intakeKA;
