...
public class IntakePivot extends SubsystemBase {
  private final TalonFX motor = new TalonFX(Constants.IntakeConstants.pivotMotorID);
  private final CANcoder encoder = new CANcoder(Constants.IntakeConstants.encoderID);
  ...
  public IntakePivot(RobotContainer rob) {
    ...
    slot0Configs.kP = Constants.IntakeConstants.downKP;
    slot0Configs.kI = Constants.IntakeConstants.downKI;
    slot0Configs.kD = Constants.IntakeConstants.downKD;
